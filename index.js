		...
		try {
			...
			switch(command) {
				...
				case 'lolivoice':
					...
					break
				case 'animeedit':
					var items = ["./media/jiraya death.mp4","./media/animeedit13.mp4","./media/animeedit14.mp4","./media/animeedit15.mp4","./media/animeedit16.mp4","./media/animeedit17.mp4","./media/animeedit18.mp4","./media/animeedit19.mp4","./media/animeedit20.mp4","./media/animeedit21.mp4","./media/animeedit22.mp4","./media/animeedit23.mp4","./media/animeedit24.mp4","./media/animeedit25.mp4","./media/animeedit26.mp4","./media/animeedit27.mp4","./media/animeedit28.mp4","./media/animeedit29.mp4","./media/animeedit30.mp4","./media/animeedit31.mp4","./media/animeedit32.mp4","./media/animeedit33.mp4","./media/animeedit34.mp4","./media/animeedit35.mp4","./media/animeedit36.mp4","./media/animeedit37.mp4","./media/animeedit38.mp4","./media/animeedit39.mp4","./media/animeedit40.mp4","./media/animeedit41.mp4","./media/animeedit42.mp4","./media/animeedit43.mp4","./media/animeedit44.mp4","./media/animeedit45.mp4","./media/animeedit46.mp4","./media/animeedit47.mp4","./media/animeedit48.mp4","./media/animeedit49.mp4","./media/animeedit50.mp4","./media/animeedit51.mp4","./media/animeedit52.mp4","./media/animeedit53.mp4","./media/animeedit54.mp4","./media/animeedit55.mp4","./media/animeedit56.mp4","./media/animeedit57.mp4","./media/animeedit58.mp4","./media/animeedit59.mp4","./media/animeedit60.mp4","./media/animeedit61.mp4","./media/animeedit62.mp4","./media/animeedit63.mp4","./media/animeedit64.mp4","./media/animeedit65.mp4","./media/animeedit66.mp4","./media/animeedit67.mp4","./media/animeedit68.mp4","./media/animeedit69.mp4","./media/animeedit70.mp4","./media/animeedit71.mp4","./media/animeedit72.mp4", "./media/animeedit1.mp4", "./media/animeedit2.mp4", "./media/animeedit3.mp4", "./media/animeedit4.mp4", "./media/animeedit5.mp4", "./media/animeedit6.mp4", "./media/animeedit7.mp4", "./media/animeedit8.mp4", "./media/animeedit9.mp4", "./media/animeedit10.mp4", "./media/animeedit11.mp4", "./media/animeedit12.mp4" ,"./media/edit3.mp4","./media/barulhinho.mp4", "./media/majin boo.mp4", "./media/melancholy.mp4", "./media/minato.mp4", "./media/Nishimiya.mp4", "./media/Nishimiya2.mp4", "./media/obito.mp4", "./media/pantsu.mp4", "./media/zero two edit.mp4" ]
				...
				case 'egirledit':
					var items = ["./media/egirl1.mp4", "./media/egirl2.mp4", "./media/egirl3.mp4", "./media/egirl4.mp4", "./media/egirl5.mp4", "./media/egirl6.mp4", "./media/egirl7.mp4", "./media/egirl8.mp4", "./media/egirl9.mp4", "./media/egirl10.mp4", "./media/egirl11.mp4", "./media/egirl12.mp4", "./media/egirl13.mp4", "./media/egirl14.mp4" , "./media/egirl15.mp4" , "./media/egirl16.mp4" , "./media/egirl17.mp4" , "./media/egirl18.mp4"  ]
					var nime = items[Math.floor(Math.random() * items.length)];
					...
					if (isGroup && isSimi && budy != undefined) {
						...
						switch(budy) 
						{
							...
							case 'yumi':
								...
								var numero = getRandomIntInclusive(0,100).toString()
								var nome = './mp3/loli (' + numero +').mp3'
								const buffer88 = fs.readFileSync(nome)
								
								client.sendMessage(from, buffer88, audio, {mimetype: 'audio/mp4', filename: `${nome}`, quoted: mek})
								break
						}
